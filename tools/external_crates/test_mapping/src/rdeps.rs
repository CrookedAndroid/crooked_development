...
impl ReverseDeps {
    ...
    fn grep_and_parse<P: Into<PathBuf>>(repo_root: P) -> Result<ReverseDeps> {
        ...
        for line in stdout.lines() {
            ...
            let (dir, _) = line.rsplit_once('/').ok_or(anyhow!("Failed to split {} on /", line))?;
